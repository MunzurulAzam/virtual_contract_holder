...
import 'package:vertualcardview/pages/contract_detail_page.dart';
...
void main() {
  runApp(ChangeNotifierProvider(create: (context) => ContractProvider(), child: const MyApp()));
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        FromPage.routeName : (context) => const FromPage(),
        ScanPage.routeName : (context) => const ScanPage(),
        ContractDetailPage.routeName : (context) => const ContractDetailPage(),
      },
    );
  }
}
